...
# Технічний опис завдання => Крок 1:
...
1. **change [ім'я] [старий телефон] [новий телефон]:** Змінити телефонний номер для вказаного контакту.
1. **phone [ім'я]:** Показати телефонні номери для вказаного контакту.
...
Для прикладу розглянемо реалізацію команди **add [ім'я] [телефон]**.<br>
У функції main ми повинні додати обробку цієї команди у відповідне місце:
